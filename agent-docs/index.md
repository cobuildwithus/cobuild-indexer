...
| `agent-docs/prompts/simplify.md` | Reusable simplification pass prompt for behavior-preserving cleanup with downloadable patch-file output. | Completion workflow | Indexer Maintainers | Per process change | Medium | 2026-03-30 |
...
| `agent-docs/prompts/task-finish-review.md` | Reusable final completion audit prompt for correctness/security review with downloadable patch-file output, including coverage/proof-gap review. | Completion workflow | Indexer Maintainers | Per process change | Medium | 2026-03-30 |
