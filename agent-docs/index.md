...
Last verified: 2026-03-13 (wire-owned scaffold start block)
...
| `agent-docs/prompts/simplify.md` | Reusable simplification pass prompt for behavior-preserving cleanup with parallel-agent handoff output. | Completion workflow | Indexer Maintainers | Per process change | Medium | 2026-03-13 |
| `agent-docs/prompts/test-coverage-audit.md` | Reusable test-coverage audit prompt for high-impact regression reduction with parallel-agent handoff output. | Completion workflow | Indexer Maintainers | Per process change | Medium | 2026-03-13 |
| `agent-docs/prompts/task-finish-review.md` | Reusable final completion audit prompt for correctness/security review with parallel-agent handoff output. | Completion workflow | Indexer Maintainers | Per process change | Medium | 2026-03-13 |
...
| `agent-docs/references/rpc-chain-config-map.md` | Chain scope, start-block, and RPC failover model. | `src/lib/config.ts`, `src/lib/rpc-transport.ts`, `ponder.config.ts` | Indexer Maintainers | Per infra/config PR | High | 2026-03-13 |
| `agent-docs/references/address-abi-provenance.md` | Address and ABI source-of-truth and update workflow. | `addresses*.ts`, `wagmi.config.ts`, `abis.ts` | Indexer Maintainers | Per deployment/ABI PR | High | 2026-03-13 |
...
- Active wire factory refresh plan: `agent-docs/exec-plans/active/2026-03-13-wire-factory-refresh.md`.
