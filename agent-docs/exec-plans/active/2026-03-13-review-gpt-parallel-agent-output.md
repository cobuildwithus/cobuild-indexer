...
- Update every repo-local Review GPT prompt used by the indexer repo so the model returns copy/paste-ready prompts for parallel fix agents, with detailed issue context and a best-guess remediation path.
