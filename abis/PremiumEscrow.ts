...
export const PremiumEscrowAbi = parseAbi([
  ...
  "event UnderwriterSlashCalculated(address indexed underwriter, bool usedSpendFormula, uint256 premiumEarned, uint32 premiumPpm, uint256 coverageLambda, uint256 duration, uint256 rawSlashWeight, uint256 capWeight, uint256 finalSlashWeight)",
